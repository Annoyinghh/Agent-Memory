...
def extract_to_memory(target_dir: str, namespace: str, db_dir: str = "./data"):
    """
    ...
    print(f"Collecting files from: {target}")
    ...
    print("Extracting AST nodes and edges...")
    ...
    import_result = engine.import_graph_data(nodes, edges, namespace)
    engine.close()

    print(f"Imported {import_result['nodes_imported']} nodes, {import_result['edges_imported']} edges into '{namespace}'")
    return import_result


def import_from_graph_json(graph_path: str, namespace: str, db_dir: str = "./data"):
    """
    ...
    print(f"Imported {result['nodes_imported']} nodes, {result['edges_imported']} edges into '{namespace}'")
    return result
